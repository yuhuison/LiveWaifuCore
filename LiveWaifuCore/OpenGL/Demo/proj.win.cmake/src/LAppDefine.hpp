...
namespace LAppDefine {
    ...
    // モデル定義--------------------------------------------
    extern csmChar* ModelDir[];               ///< モデルを配置したディレクトリ名の配列. ディレクトリ名とmodel3.jsonの名前を一致させておく.
    ...
    extern int callback_windowLoaded;
    extern bool has_callback_windowLoaded;
    typedef void(*function)(int);
    extern void SetRenderSize(int w, int h);
